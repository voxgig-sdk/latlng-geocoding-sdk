...
|---|---|---|
| `ts/` | @voxgig-sdk/latlng-geocoding-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/latlng-geocoding-sdk \
      --repository voxgig-sdk/latlng-geocoding-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/latlng-geocoding-sdk` shows it, and
`npm trust revoke @voxgig-sdk/latlng-geocoding-sdk --id=<id>` removes it.
