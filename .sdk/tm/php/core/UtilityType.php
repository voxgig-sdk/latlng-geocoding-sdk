...
// LatlngGeocoding SDK utility type

class LatlngGeocodingUtility
{
    ...
    public static function copy(LatlngGeocodingUtility $src): LatlngGeocodingUtility
    {
        $u = new LatlngGeocodingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
