...
// LatlngGeocoding SDK cache feature
...
class LatlngGeocodingCacheFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _through(LatlngGeocodingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
