...
// LatlngGeocoding SDK metrics feature
...
class LatlngGeocodingMetricsFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _record(LatlngGeocodingContext $ctx, bool $ok): void
    {
