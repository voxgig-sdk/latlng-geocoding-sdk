...
// LatlngGeocoding SDK netsim feature
...
class LatlngGeocodingNetsimFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _simulate(LatlngGeocodingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LatlngGeocodingContext $ctx, array $applied): void
    {
        $client = $this->client;
