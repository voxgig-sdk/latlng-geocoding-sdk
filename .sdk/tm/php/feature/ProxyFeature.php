...
// LatlngGeocoding SDK proxy feature
...
class LatlngGeocodingProxyFeature extends LatlngGeocodingBaseFeature
{
    ...
    public function init(LatlngGeocodingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LatlngGeocodingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
