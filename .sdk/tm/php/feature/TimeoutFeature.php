...
// LatlngGeocoding SDK timeout feature
...
class LatlngGeocodingTimeoutFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _with_timeout(LatlngGeocodingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LatlngGeocodingContext $_ctx, float $ms): void
    {
        $client = $this->client;
