...
// LatlngGeocoding SDK utility: fetcher

class LatlngGeocodingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LatlngGeocodingSDK/1.0)';
    ...
    public static function call(LatlngGeocodingContext $ctx, string $fullurl, array $fetchdef): array
    {
