...
// LatlngGeocoding SDK utility: graphql
//
...
class LatlngGeocodingGraphql
{
    ...
    // equivalent.
    public static function body(LatlngGeocodingContext $ctx): mixed
    {
    ...
    public static function errors(LatlngGeocodingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
