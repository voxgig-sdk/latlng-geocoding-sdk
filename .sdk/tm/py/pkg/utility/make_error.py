...
from projectname_sdk.core.control import LatlngGeocodingControl
from projectname_sdk.core.error import LatlngGeocodingError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import LatlngGeocodingContext
        ctx = LatlngGeocodingContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, LatlngGeocodingError):
        errmsg = err.msg
    ...
    sdk_err = LatlngGeocodingError("", msg, ctx)
