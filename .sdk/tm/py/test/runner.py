...
class LatlngGeocodingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LatlngGeocodingTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LatlngGeocodingTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LatlngGeocodingTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
