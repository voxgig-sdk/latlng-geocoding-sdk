...
func registerSDKWords(r *eng.Registry, client *sdk.LatlngGeocodingSDK) {
...
func runOp(client *sdk.LatlngGeocodingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
