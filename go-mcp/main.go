// Command LatlngGeocoding-mcp is an MCP server exposing the LatlngGeocoding
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LatlngGeocoding_list  — list records of an entity
//	LatlngGeocoding_load  — load a single record of an entity
//
