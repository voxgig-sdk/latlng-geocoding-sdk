...
type Args struct {
	Entity string         `json:"entity" jsonschema:"api | dataset | map | place | reverse | utility"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.LatlngGeocodingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "latlng-geocoding_list",
		Description: "List records from LatlngGeocoding. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "latlng-geocoding_load",
		Description: "Load a single record from LatlngGeocoding. " +
...
func runOp(client *sdk.LatlngGeocodingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.LatlngGeocodingSDK, name string) (sdk.LatlngGeocodingEntity, error) {
