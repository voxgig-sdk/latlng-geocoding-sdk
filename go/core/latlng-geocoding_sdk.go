...
type LatlngGeocodingSDK struct {
	Mode     string
...
func (sdk *LatlngGeocodingSDK) OptionsMap() map[string]any {
...
func (sdk *LatlngGeocodingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *LatlngGeocodingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *LatlngGeocodingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LatlngGeocodingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *LatlngGeocodingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *LatlngGeocodingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("LatlngGeocodingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *LatlngGeocodingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LatlngGeocodingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("LatlngGeocodingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *LatlngGeocodingSDK) Api(data map[string]any) LatlngGeocodingEntity {
...
func (sdk *LatlngGeocodingSDK) Dataset(data map[string]any) LatlngGeocodingEntity {
...
func (sdk *LatlngGeocodingSDK) Map(data map[string]any) LatlngGeocodingEntity {
...
func (sdk *LatlngGeocodingSDK) Place(data map[string]any) LatlngGeocodingEntity {
...
func (sdk *LatlngGeocodingSDK) Reverse(data map[string]any) LatlngGeocodingEntity {
...
func (sdk *LatlngGeocodingSDK) Utility(data map[string]any) LatlngGeocodingEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *LatlngGeocodingSDK {
	...
	sdk := NewLatlngGeocodingSDK(sdkopts)
	sdk.Mode = "test"
