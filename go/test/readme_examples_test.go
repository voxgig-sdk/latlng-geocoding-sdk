...
const testSeed = `map[string]any{"entity": map[string]any{"api": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dataset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reverse": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "utility": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
