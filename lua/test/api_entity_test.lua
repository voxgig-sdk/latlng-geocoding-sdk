...
describe("ApiEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LATLNGGEOCODING_TEST_API_ENTID JSON to run live")
      return
    end
...
function api_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LATLNGGEOCODING_TEST_API_ENTID")
