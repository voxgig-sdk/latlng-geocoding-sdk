...
local SDK_MODULE = "latlng-geocoding_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["api"] = { ["test01"] = { id = "test01" } }, ["dataset"] = { ["test01"] = { id = "test01" } }, ["map"] = { ["test01"] = { id = "test01" } }, ["place"] = { ["test01"] = { id = "test01" } }, ["reverse"] = { ["test01"] = { id = "test01" } }, ["utility"] = { ["test01"] = { id = "test01" } } } }'
