...
describe("ReverseDirect", function()
  it("should direct-list-reverse", function()
    local setup = reverse_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-reverse", setup.live and "live" or "unit")
