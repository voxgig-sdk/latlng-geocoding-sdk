...
function runner.env_override(m)
  local live = runner.getenv("LATLNG_GEOCODING_TEST_LIVE")
  local override = runner.getenv("LATLNG_GEOCODING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LATLNG_GEOCODING_TEST_EXPLAIN")
