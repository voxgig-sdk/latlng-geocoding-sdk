...
// LatlngGeocoding SDK Map entity
...
class MapEntity
{
     ...
     * Create a new Map.
     *
     * @param MapCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MapCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Map|array The created Map as an assoc-array at the
     *   SDK boundary; throws LatlngGeocodingError on failure (item-5 convention).
     */
