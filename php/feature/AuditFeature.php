...
// LatlngGeocoding SDK audit feature
...
class LatlngGeocodingAuditFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _emit(LatlngGeocodingContext $ctx, string $outcome): void
    {
