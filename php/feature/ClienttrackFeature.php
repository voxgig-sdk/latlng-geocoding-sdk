...
// LatlngGeocoding SDK clienttrack feature
...
class LatlngGeocodingClienttrackFeature extends LatlngGeocodingBaseFeature
{
    ...
    public function PostConstruct(LatlngGeocodingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LatlngGeocoding-SDK';
