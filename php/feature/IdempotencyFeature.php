...
// LatlngGeocoding SDK idempotency feature
...
class LatlngGeocodingIdempotencyFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _mutating(LatlngGeocodingContext $ctx): bool
    {
