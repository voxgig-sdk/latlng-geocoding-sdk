...
// LatlngGeocoding SDK ratelimit feature
...
class LatlngGeocodingRatelimitFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _acquire(LatlngGeocodingContext $ctx): void
    {
    ...
    private function _track(LatlngGeocodingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
