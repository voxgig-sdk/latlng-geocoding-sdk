...
// LatlngGeocoding SDK rbac feature
...
class LatlngGeocodingRbacFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _required(LatlngGeocodingContext $ctx): ?string
    {
    ...
    private function _reject(LatlngGeocodingContext $ctx, string $required): void
    {
    ...
    private function _track(LatlngGeocodingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
