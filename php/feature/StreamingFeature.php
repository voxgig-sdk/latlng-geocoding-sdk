...
// LatlngGeocoding SDK streaming feature
...
class LatlngGeocodingStreamingFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _iterate(LatlngGeocodingResult $result): \Generator
    {
    ...
    private function _streamable(LatlngGeocodingContext $ctx): bool
    {
