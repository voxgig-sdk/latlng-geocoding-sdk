...
// LatlngGeocoding SDK telemetry feature
...
class LatlngGeocodingTelemetryFeature extends LatlngGeocodingBaseFeature
{
    ...
    private function _close(LatlngGeocodingContext $ctx, bool $ok): void
    {
