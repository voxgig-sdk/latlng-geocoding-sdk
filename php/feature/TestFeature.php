...
// LatlngGeocoding SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LatlngGeocodingTestFeature extends LatlngGeocodingBaseFeature
{
    ...
    public function init(LatlngGeocodingContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LatlngGeocodingContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LatlngGeocodingParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LatlngGeocodingContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LatlngGeocodingContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = LatlngGeocodingParam::call($ctx, $k);
