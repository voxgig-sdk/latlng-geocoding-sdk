...
// LatlngGeocoding SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LatlngGeocodingSDK::test)
...
{
    private const SDK_CLASS = 'LatlngGeocodingSDK';
    ...
    private const SDK_BASE = 'latlnggeocoding_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../latlnggeocoding_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
