...
{
    public function test_direct_list_reverse(): void
    {
        $setup = reverse_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-reverse", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
