...
// LatlngGeocoding SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LatlngGeocodingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LatlngGeocodingOmni::structfix($now, Struct::undef()))
                        !== json_encode(LatlngGeocodingOmni::structfix($val, Struct::undef()))) {
