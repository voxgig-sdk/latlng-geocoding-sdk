...
// LatlngGeocoding SDK utility: make_options

class LatlngGeocodingMakeOptions
{
    ...
    public static function call(LatlngGeocodingContext $ctx): array
    {
        ...
        //
        // `LatlngGeocodingSchema::optspec()` is built from the model:
        ...
        $optspec = LatlngGeocodingSchema::optspec();
