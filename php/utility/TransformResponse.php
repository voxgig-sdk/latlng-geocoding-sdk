...
// LatlngGeocoding SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LatlngGeocodingTransformResponse
{
    public static function call(LatlngGeocodingContext $ctx): mixed
    {
        ...
        $transform = LatlngGeocodingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
