# LatlngGeocoding Python SDK



The Python SDK for the LatlngGeocoding API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/latlng-geocoding-sdk/releases)) or
...
client = LatlngGeocodingSDK({
    "apikey": os.environ.get("LATLNG_GEOCODING_APIKEY"),
})
```
