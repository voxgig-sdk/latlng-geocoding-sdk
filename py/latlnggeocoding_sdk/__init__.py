...
from latlnggeocoding_sdk.utility import register

# Load features
from latlnggeocoding_sdk.feature.base_feature import LatlngGeocodingBaseFeature
from latlnggeocoding_sdk.features import _has_feature, _make_feature
...
class LatlngGeocodingSDK:
    ...
    def get_utility(self):
        return LatlngGeocodingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LatlngGeocodingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from latlnggeocoding_sdk.entity.api_entity import ApiEntity
    ...
    def Reverse(self, data=None) -> "ReverseEntity":
        ...
        from latlnggeocoding_sdk.entity.reverse_entity import ReverseEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from latlnggeocoding_sdk.entity.utility_entity import UtilityEntity
        return UtilityEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "LatlngGeocodingSDK":
        if sdkopts is None:
            sdkopts = {}
