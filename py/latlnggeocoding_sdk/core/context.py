...
from latlnggeocoding_sdk.core.helpers import get_ctx_prop, to_map
...
class LatlngGeocodingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = LatlngGeocodingControl()
        ...
        if isinstance(sp, LatlngGeocodingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LatlngGeocodingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LatlngGeocodingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return LatlngGeocodingOperation({})
    ...
    def make_error(self, code, msg):
        return LatlngGeocodingError(code, msg, self)
