...
from latlnggeocoding_sdk.latlnggeocoding_types import (
    Reverse,
    ReverseListMatch,
)
...
class ReverseEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Reverse]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Reverse().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
