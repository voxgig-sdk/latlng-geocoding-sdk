    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LATLNGGEOCODING_TEST_MAP_ENTID JSON to run live")
        client = setup["client"]
        ...
        map_ref01_data = helpers.to_map(map_ref01_ent.create(map_ref01_data, None))
...
def _map_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "LATLNGGEOCODING_TEST_MAP_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LATLNGGEOCODING_TEST_MAP_ENTID"))
