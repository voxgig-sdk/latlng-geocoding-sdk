# LatlngGeocoding SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LatlngGeocodingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LatlngGeocodingSDK(...) and LatlngGeocodingSDK.test(...) become
#      LatlngGeocodingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "latlnggeocoding_sdk"
_SDK_CLASS = "LatlngGeocodingSDK"
