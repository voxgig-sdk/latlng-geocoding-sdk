# LatlngGeocoding Ruby SDK



The Ruby SDK for the LatlngGeocoding API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `LatlngGeocodingError` (a `StandardError` subclass), so wrap
...
The main module (`LatlngGeocoding_sdk`) exports the SDK class
