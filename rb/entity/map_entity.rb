...
class MapEntity
  ...
  # @return [Map, Hash] the loaded Map; raises LatlngGeocodingError on failure
  ...
  # Create a new Map.
  #
  # @param reqdata [MapCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Map, Hash] the created Map; raises LatlngGeocodingError on failure
