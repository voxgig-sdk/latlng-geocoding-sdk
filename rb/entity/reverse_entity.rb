# LatlngGeocoding SDK Reverse entity
...
class ReverseEntity
  ...
  #
  # @param reqmatch [ReverseListMatch, Hash, nil] match filter (any subset of
  #   Reverse fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Reverse>, Array] the matching Reverse items; raises LatlngGeocodingError on failure
