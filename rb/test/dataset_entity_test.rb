...
class DatasetEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LATLNGGEOCODING_TEST_DATASET_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def dataset_basic_setup(extra)
  ...
  entid_env_raw = ENV["LATLNGGEOCODING_TEST_DATASET_ENTID"]
