...
function envOverride(m) {
    if ('TRUE' === process.env.LATLNG_GEOCODING_TEST_LIVE ||
        'TRUE' === process.env.LATLNG_GEOCODING_TEST_OVERRIDE) {
    ...
    m.LATLNG_GEOCODING_TEST_EXPLAIN = process.env.LATLNG_GEOCODING_TEST_EXPLAIN || m.LATLNG_GEOCODING_TEST_EXPLAIN;
    return m;
}
