...
class DatasetEntity extends LatlngGeocodingEntityBase<Dataset> {
  ...
  async remove(
    this: any, reqmatch?: DatasetRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DatasetEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
