...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.LATLNGGEOCODING_TEST_LIVE ||
    'TRUE' === process.env.LATLNGGEOCODING_TEST_OVERRIDE
  ) {
  ...
  m.LATLNGGEOCODING_TEST_EXPLAIN = process.env.LATLNGGEOCODING_TEST_EXPLAIN || m.LATLNGGEOCODING_TEST_EXPLAIN
